...
export function CampaignDetailPage() {
  ...
  const campaign: Campaign = useSuspenseQuery(
        ...
        <Card>
          ...
          <CardContent className="space-y-2 pt-5">
            ...
            <p className="text-xs text-muted-foreground">
              ...
              attributed here. The tag is fixed when the campaign is created and
              does not change if you rename it, so links already running in an
              ad platform keep working.
            </p>
          </CardContent>
        </Card>
