...
export const analyticsEvents = pgTable(
  'analytics_events',
  {
    ...
    // Which creative the visitor clicked: the platform's ad id, which the Link
    // Tags write here as `utm_campaign` carries the campaign id. Nullable and
    // never backfilled: an event that arrived before this column existed
    // carries no ad id.
